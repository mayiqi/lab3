...
@pytest.fixture
def engine():
    engine = create_engine('sqlite:///EnglishPalDatabase.db') #自己的路径
    #engine = create_engine(r'sqlite:///C:\Users\drlan\Downloads\Teaching\SoftArch\Labs\Lab3\read\EnglishPalDatabase.db') # use your own path
    return engine
